...
let res= await fetch(SummeryApi.Logout.url,{
   ...
   <div className='h-[94vh] fixed top-[10vw] md:top-[6vw]   left-0 bg-[#edfcf5]' > 
    <div className='flex items-center justify-between'>
      <a className='text-[2vw] text-red-500  ml-[1vw] font-bold'>Retailer</a>
...
<Link to='/all-product' className='text-[1.7vw] text-blue-500 py-2 pl-1'> Products</Link>
